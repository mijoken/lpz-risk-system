#!/usr/bin/env python3
"""Download official JMA primary-subdivision GIS and build a compact bbox registry."""
...
from lpz_risk.historical_spatial import build_primary_subdivision_registry  # noqa: E402
